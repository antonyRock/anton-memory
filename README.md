...
**Несколько пользователей** — у каждого пользователя собственные чаты, память, документы и проекты. Данные изолированы друг от друга.
